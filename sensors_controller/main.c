...
/*
 *
 * CHANGED THIS EXAMPLE TO USE  BOOSTERPACK 2   INSTEAD OF BOOSTERPACK 1
  (the original TI example is for BOOSTERPACK 1)

  the interrupt vector table entry needs be changed.
 *
 */
